...
public class FakeDataSource {
    ...
    public static final String TXT_TITLE_04 = "Nadja-based designer making stuff with Studio";
    public static final String TXT_TITLE_05 = "How To Write Better Resume";


    List<String> listNewsTitles = new ArrayList<>();

    public static final String TXT_NAME_01 = "Jona Dingoes";
    public static final String TXT_NAME_02 = "Invision Studio";
    public static final String TXT_NAME_03 = "Benoit Drying";
    public static final String TXT_NAME_04 = "Ada Vishnu's";

    List<String>  listUserNames  = new ArrayList<>();


    public static final String LOREM_TEXT ="Lorem ipsum, or ipsum as it is sometimes known, is dummy text used in laying out print, graphic or web designs. The passage is attributed to an unknown typesetter in the 15th century who is thought to have scrambled parts of Cicero's De Minibus Bonjour et Mallory for use in a type specimen book. It usually begins with: The purpose of lorem ipsum is to create a natural looking block of text (sentence, paragraph, page, etc.) that doesn't distract from the layout. A practice not without controversy, laying out pages with meaningless filler text can be very useful when the focus is meant to be on design, not content." ;
    ...
    public NewsItem generateRandomNewsItem(){
        ...
        return new NewsItem(-1, getRandomNewsTitle(), getRandomUsername(), getRandomNewsImage(), getRandomUserImage(), getRandomContent(), getRandomBgColor(), null, 0);
    }
